...
const ModeToggler = () => {
  ...
  return (
    <div className="flex gap-2  max-w-max px-2 py-1 rounded-2xl bg-gray-300  dark:bg-gray-800">
      <button
        className="w-5 h-5 border-2 border-transparent focus:border-gray-800 dark:focus:border-gray-300"
      ...
      >
        <svg
          ...
          width="18"
          viewBox="0 0 48 48"
          className="fill-blue-600 dark:fill-gray-300"
        >
      ...
      >
        <svg
          ...
          width="18"
          viewBox="0 0 48 48"
          className="fill-slate-800 dark:fill-blue-400"
        >
