const Topbar = () => {
  return (
    <header
      className={
        "flex w-full md:hidden fixed  top-0 left-0 right-0 h-16 bg-white/90 dark:bg-gray-800/90 z-40 " +
    ...
    >
      ...
      <div className="absolute top-1/2 left-5  -translate-y-1/2">
        <button className="relative w-[40px] h-[40px] rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 duration-300">
          <svg
